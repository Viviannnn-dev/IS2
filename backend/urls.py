...
from . import views
from .views import get_workspaces, get_boards , create_board, get_lists , create_list, get_lists_by_board,get_list_by_id,get_cards_by_list,delete_list,get_users,get_users_id,get_tasks_by_card,get_boards_by_workspace,get_tasks_by_board,get_tasks_by_board_and_user,google_login,get_workspaces_by_user
...
urlpatterns = [
    ...
    path('api/users/',get_users , name='list_users'),  # Para listar todos los workspaces 
    ...
    path('api/workspaces/user/<int:user_id>/', get_workspaces_by_user, name='get_workspaces_by_user'),
    ...
    path('api/lists/delete/<int:list_id>/',delete_list, name='delete-list'),  # Para listar todas las listas
    ...
    path('api/googleLogin/', views.google_login, name='google_login'),
]
